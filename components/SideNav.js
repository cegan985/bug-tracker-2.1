...
function SideNav() {
  ...
  return (
        <div>
            ...
            <div className={`grid grid-cols-1 shadow-2xl justify-start bg-white dark:bg-slate-800  dark:border-slate-700 p-6 h-[calc(100vh-60px)] z-40 fixed -left-96 ${open ? 'w-72' : 'w-20'} lg:left-0 peer-focus:left-0 peer:transition ease-out duration-300`}>
